...
public class InventoryOLD : ItemContainer
{
    ...
    public bool Remove(ItemOLD item, int amount)
    {
    ...
    public bool CanAdd(ItemOLD item, int amount)
    {
    ...
    public bool Add(ItemOLD item, int amount)
    {
