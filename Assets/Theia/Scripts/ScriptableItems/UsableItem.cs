...
#pragma warning restore CS0649 // Field never assigned to
    ...
    public virtual bool CanUse(PlayerOLD player, int inventoryIndex)
    {
    ...
    public virtual void Use(PlayerOLD player, int inventoryIndex)
    {
    ...
    public virtual void OnUsed(PlayerOLD player) {}
