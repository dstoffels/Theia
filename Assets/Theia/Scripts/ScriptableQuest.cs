...
public abstract class ScriptableQuest : ScriptableObject
{
    ...
    // events to hook into /////////////////////////////////////////////////////
    public virtual void OnKilled(PlayerOLD player, int questIndex, EntityOLD victim) {}
    public virtual void OnLocation(PlayerOLD player, int questIndex, Collider location) {}

    // fulfillment /////////////////////////////////////////////////////////////
    // we pass the Quest instead of an index for ease of use and because we are
    // read-only here anyway
    public abstract bool IsFulfilled(PlayerOLD player, Quest quest);

    // OnComplete is called when the quest is completed at the npc.
    // -> can be used to remove quest items from the inventory, etc.
    public virtual void OnCompleted(PlayerOLD player, Quest quest) {}
    ...
    * {REWARDITEM}
    ...
    {STATUS}
    */
    public virtual string ToolTip(PlayerOLD player, Quest quest)
    {
