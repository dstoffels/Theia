...
public class NpcQuests : NpcOffer
{
    ...
    public List<ScriptableQuest> QuestsVisibleFor(PlayerOLD player)
    {
    ...
    void Update()
    {
        ...
        if (questOverlay != null)
        {
            ...
            {
                if (CanPlayerCompleteAnyQuestHere(PlayerOLD.localPlayer.quests))
                    questOverlay.text = "!";
                else if (CanPlayerAcceptAnyQuestHere(PlayerOLD.localPlayer.quests))
                    questOverlay.text = "?";
                else
                    questOverlay.text = "";
            }
