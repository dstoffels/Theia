...
public partial struct Quest
{
    ...
    // events
    public void OnKilled(PlayerOLD player, int questIndex, EntityOLD victim) { data.OnKilled(player, questIndex, victim); }
    public void OnLocation(PlayerOLD player, int questIndex, Collider location) { data.OnLocation(player, questIndex, location); }

    // completion
    public bool IsFulfilled(PlayerOLD player) { return data.IsFulfilled(player, this); }
    public void OnCompleted(PlayerOLD player) { data.OnCompleted(player, this); }
    ...
    public string ToolTip(PlayerOLD player)
    {
