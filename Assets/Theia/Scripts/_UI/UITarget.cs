...
public partial class UITarget : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (player != null)
        {
            ...
            EntityOLD target = player.nextTarget ?? player.target;
            if (target != null && target != player)
            {
                ...
                // guild invite button
                if (target is PlayerOLD targetPlayer && player.guild.InGuild())
                {
                ...
                // party invite button
                if (target is PlayerOLD targetPlayer2)
                {
