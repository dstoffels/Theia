...
#if UNITY_2019_4
                Debug.Log("uMMORPG CE | u3d.as/1GXA | https://discord.gg/2gNKN78");
#else
                Debug.LogWarning("uMMORPG CE works best with Unity 2019.4 LTS: https://unity3d.com/unity/qa/lts-releases?version=2019.4");
#endif
            }
        }
    }
